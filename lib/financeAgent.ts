...
const tools: Anthropic.Tool[] = [
  {
    ...
    input_schema: {
      ...
      properties: {
        ...
        description: {
          type: "string",
          description: "Short free-text note, e.g. merchant or purpose.",
        },
        date: {
          type: "string",
          description:
...
4. เมื่อผู้ใช้ส่งรูปสลิปการโอนเงิน/ใบเสร็จมาให้ ให้อ่านยอดเงิน วันที่ และรายละเอียดที่เกี่ยวข้องจากรูป แล้วเรียกใช้ log_transaction เพื่อบันทึกเหมือนกรณีข้อความปกติ เลือกหมวดหมู่ตามบริบทที่เห็นในสลิป (เช่น ข้อความหมายเหตุการโอน) ถ้าเดาหมวดหมู่ไม่ได้ให้ใช้ Other ถ้ารูปที่ส่งมาไม่ใช่สลิปการโอนเงินหรืออ่านยอดเงินไม่ออกเลย ห้ามเดา ให้ตอบอธิบายตามตรงว่าอ่านไม่ได้ และไม่ต้องเรียก log_transaction
